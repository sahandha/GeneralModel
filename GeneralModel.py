...
class GeneralModel:
    ...
    def UpdateRK(self):
        k1 = self.Flow(self._t, self._x)
        k2 = self.Flow(self._t+self._dt/2, self._x+k1*self._dt/2)
        k3 = self.Flow(self._t+self._dt/2, self._x+k2*self._dt/2)
        k4 = self.Flow(self._t+self._dt  , self._x+k2*self._dt)
